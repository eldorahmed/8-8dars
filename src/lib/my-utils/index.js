...
export const validation = (obj) => {
  ...
  const errors = {
    ...
    name: "Rasim nomini kiriting",
    price: "Narxni kiriting",
    summary: "Izohni kiriting",
    smell: "Hidni kiriting",
    category: "Turkumni tanlang",
    country: "Hududni tanlang",
    lifetime: "Gullash vaqtini kiriting",
...
export function myTranslation(word) {
  switch (word) {
    case "category":
      return "Turkum bo'yicha";
    case "country":
      return "Davlat bo'yicha";
    case "color":
      return "Rang bo'yicha";
    default:
      return "Bunday element mavjud emas";
  }
}
export function collectStatsData(arr, type) {
  const result = {};
  const data=[]
  for (let obj of arr) {
    const value = result[obj[type]];
...
export const neededStatisticsReport = ["category", "country", "color"];
